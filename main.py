...
"Main executor Script, only for write history data of accumulated return into the table"
...
from Potential_Trans_Hive import Save_Table, Add_UUID
import datetime
import warnings
...
accum_ret_all["updatetime"] = datetime.date.today().strftime("%Y-%m-%d")
...
stat_all_df["updatetime"] = datetime.date.today().strftime("%Y-%m-%d")
